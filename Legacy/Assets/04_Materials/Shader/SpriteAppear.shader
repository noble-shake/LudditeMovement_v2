Shader "Lucide-Boundary/SpriteAppearShader"
{
    Properties
    {
        ...
        _Progression("Progression", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float WorldPosition = i.positionWS.y + _PlaneNormal.y * (2.0f - _Progression * 2.0f);
                if(WorldPosition < i.positionWS.y + _PlaneNormal.y) discard;
